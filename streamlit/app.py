...
def show_homepage():
    ...
    st.markdown("<p style='text-align:center;'><em>Safety Hazard Identification and Emergency Law Deployment</em></p>", unsafe_allow_html=True)
    ...
    st.markdown("<p style='text-align:center;'>cohorte dec23_mlops // <span style='color:#6ab7ff;'>Datascientest</span></p>", unsafe_allow_html=True)
