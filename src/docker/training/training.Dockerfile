...
ARG MICROSERVICE_SCRIPT_01="${MICROSERVICE_DIRECTORY}/${MICROSERVICE_NAME}_script.py"
ARG MICROSERVICE_SCRIPT_02="${MICROSERVICE_DIRECTORY}/re${MICROSERVICE_NAME}_script.py"
...
# copy microservice script files
