...
class Data:
    def __init__(self, start_year, end_year, root_path):
        """constructor

        Args:
            start_year (int): first year of data
            end_year (int): last year of data, could the same than start_year
            root_path (string): fullpath of the repository (this allows to move the current library)
        """
        ...
        self.raw_path = create_folder_if_necessary(os.path.join(root_path, "data", "raw"))
        self.cleaned_path = create_folder_if_necessary(os.path.join(root_path, "data", "cleaned"))
        self.preprocessed_path = create_folder_if_necessary(os.path.join(root_path, "data", "preprocessed"))
